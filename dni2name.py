...
class dni2name:
    ...
    def checkDNI(self, id):
        ''' base method: search for a DNI in google and try to extract a full name. '''
    ...
    def extractName(self, result):
        ''' two simple rules to extract fullnames from a given google ranked pages. '''
    ...
    def checkRange(self, min, max):
        ''' search for names for the dnis between min and max. '''
